...
using UnityEngine;
[CreateAssetMenu(menuName = "Acoes/Batalha/Ataques/Golpe Unico Clona Modificador")]

public class GolpeUnicoCloneModificador : AcaoNaBatalha
{
            ...
            else
            {
                ...
                if (acertou)
                {
                    ...
                    AjeitarListaDeModificadores(ref modificadoresAtaques, ref modificadoresDefesa, ref modificadoresSpAtaques, ref modificadoresSpDefesa, ref modificadoresVelocidade, 
                        comandoDeAtaque.AlvoAcao[i].Monstro.GetMonstro.AtributosAtuais.ModificadorDebuffAtaque,
                        comandoDeAtaque.AlvoAcao[i].Monstro.GetMonstro.AtributosAtuais.ModificadorDebuffDefesa,
                        comandoDeAtaque.AlvoAcao[i].Monstro.GetMonstro.AtributosAtuais.ModificadorDebuffSpAtaque, 
                        comandoDeAtaque.AlvoAcao[i].Monstro.GetMonstro.AtributosAtuais.ModificadorDebuffSpDefesa
                        , comandoDeAtaque.AlvoAcao[i].Monstro.GetMonstro.AtributosAtuais.ModificadorDebuffVelocidade);
